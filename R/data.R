...
#'
#' The processed \code{reh} object of a randomly generated sequence of relational events with 20 actors and 1000 events. The event sequence is generated by following an actor-oriented modeling approach (for more information on the algorithm used for the generation, refer to \code{help(topic = remulateActor, package = "remulate")} or \code{?remulate::remulateActor}).
#'
#'
#' @name ao_reh
#' @docType data
