...
#'
#'
#' @format \code{ao_reh} is an \code{reh} object containing the following additional attributes:
#'\itemize{
...
#'
#' The processed \code{reh} object of a randomly generated sequence of relational events with 5 actors and 100 events. The event sequence is generated by following a tie-oriented modeling approach (for more information run on console \code{help(topic = remulateTie, package = "remulate")} or \code{?remulate::remulateTie}).
#'
#'
#' @name tie_reh
#' @docType data
#'
#'
#' @format \code{tie_reh} is an \code{reh} object containing the following additional attributes:
#'\itemize{
